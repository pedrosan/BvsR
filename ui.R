...
shinyUI(fluidPage(
    tags$style(type="text/css",
      ...
      "h3 {color: #AF0810 !important; padding: 0px 0px 0px 4px !important; margin: 0px 0px 0px 4px !important; border: 0px solid black; }",
      ...
      tabPanel("Description", 
        ...
        fluidRow(
	      ...
	      strong("Initial Fixed Costs ($) :"), span("Additional cost incurred when buying a property, e.g. closing costs, or repairs"), br(), 
    	    ...
    	    h4("Rent"),
              strong("Rent, Monthly ($) :"), br(), 
	      strong("Renter Insurance ($) :"), br(),
	      strong("Fraction of Saved Cash Re-invested (%) :"),
            div("", style = "padding: 6px 0px 0px 0px !important; width: 100%; "),
